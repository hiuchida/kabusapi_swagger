...
public interface SendorderApi {
    ...
    ResponseEntity<OrderSuccess> sendoderFuturePost(@Parameter(in = ParameterIn.HEADER, description = "トークン発行メソッドで取得した文字列" ,required=true,schema=@Schema()) @RequestHeader(value="X-API-KEY", required=true) String X_API_KEY
, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody RequestSendOrderDerivFuture body
    ...
    @RequestMapping(value = "/sendorder/option",
        ...
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<OrderSuccess> sendorderOptionPost(@Parameter(in = ParameterIn.HEADER, description = "トークン発行メソッドで取得した文字列" ,required=true,schema=@Schema()) @RequestHeader(value="X-API-KEY", required=true) String X_API_KEY
, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody RequestSendOrderDerivOption body
    ...
    @RequestMapping(value = "/sendorder",
        ...
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<OrderSuccess> sendorderPost(@Parameter(in = ParameterIn.HEADER, description = "トークン発行メソッドで取得した文字列" ,required=true,schema=@Schema()) @RequestHeader(value="X-API-KEY", required=true) String X_API_KEY
