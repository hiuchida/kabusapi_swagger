...
@Validated
@NotUndefined
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2026-05-28T12:56:12.136027679Z[GMT]")
...
public class RequestSendOrder   {
  ...
  /**
   * 市場コード <table>   <thead>       <tr>           <th>定義値</th>           <th>説明</th>       </tr>   </thead>   <tbody>       <tr>           <td>1</td>           <td>東証※</td>       </tr>       <tr>           <td>3</td>           <td>名証</td>       </tr>       <tr>           <td>5</td>           <td>福証</td>       </tr>       <tr>           <td>6</td>           <td>札証</td>       </tr>       <tr>           <td>9</td>           <td>SOR</td>       </tr>       <tr>           <td>27</td>           <td>東証+</td>       </tr>   </tbody> </table>  ※SORまたは、東証+がメンテナンス中は現物のみ東証への指定が可能です。<br> 通常時に東証を指定しての新規発注はできません。<br> ※信用建玉の返済注文につきましては、返済期限までは東証で返済可能です。<br> 東証で保有している建玉をSORまたは東証+では返済できませんのでご注意ください。
   * @return exchange
   **/
  
  @Schema(required = true, description = "市場コード <table>   <thead>       <tr>           <th>定義値</th>           <th>説明</th>       </tr>   </thead>   <tbody>       <tr>           <td>1</td>           <td>東証※</td>       </tr>       <tr>           <td>3</td>           <td>名証</td>       </tr>       <tr>           <td>5</td>           <td>福証</td>       </tr>       <tr>           <td>6</td>           <td>札証</td>       </tr>       <tr>           <td>9</td>           <td>SOR</td>       </tr>       <tr>           <td>27</td>           <td>東証+</td>       </tr>   </tbody> </table>  ※SORまたは、東証+がメンテナンス中は現物のみ東証への指定が可能です。<br> 通常時に東証を指定しての新規発注はできません。<br> ※信用建玉の返済注文につきましては、返済期限までは東証で返済可能です。<br> 東証で保有している建玉をSORまたは東証+では返済できませんのでご注意ください。")
  ...
  @Schema(description = "資産区分（預り区分）<br>※現物買は、指定必須。<br>※現物売は、「'  '」 半角スペース2つを指定必須。<br>※信用新規と信用返済は、「11」を指定するか、または指定なしでも可。指定しない場合は「11」が自動的にセットされます。 <table>   <thead>       <tr>           <th>定義値</th>           <th>説明</th>       </tr>   </thead>   <tbody>       <tr>           <td>(半角スペース2つ)</td>           <td>現物売の場合</td>       </tr>       <tr>           <td>02</td>           <td>保護</td>       </tr>       <tr>           <td>AA</td>           <td>信用代用</td>       </tr>       <tr>           <td>11</td>           <td>信用取引</td>       </tr>   </tbody> </table>")
